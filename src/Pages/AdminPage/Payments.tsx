      ...
      <div className="min-h-screen w-full flex flex-col shadow-lg bg-white">
        ...
        <div className="overflow-auto px-2">
          <div className="min-w-[900px]">
            <div className="grid grid-cols-6 bg-indigo-900 text-white font-semibold text-sm sticky top-0 z-10 p-2">
              <span>Sr#</span>
              <span>Customer</span>
              <span>Amount</span>
            ...
            {paginatedPayments.length === 0 ? (
              ...
              paginatedPayments.map((payment, index) => (
                <div
                  key={payment.id}
                  className="grid grid-cols-6 border-b border-x border-gray-200 text-gray-800 items-center text-sm p-2 hover:bg-gray-50"
                >
        ...
        <div className="flex flex-row items-center justify-between p-2">
          ...
          <Pagination
            pageNo={pageNo}
            totalNum={filteredPayments.length}
            pageSize={pageSize}
