...
export const EmployeeWithdraw = ({ triggerAdd }: { triggerAdd: number }) => {
                ...
                >
                  ...
                  <span className="flex flex-nowrap justify-center gap-2">
                    <button
                      ...
                      className="flex items-center gap-1 p-1 px-2 rounded-xl bg-blue-50 hover:cursor-pointer
                    ...
                    <button
                      ...
                      className="flex items-center gap-1 p-1 px-2 rounded-xl bg-green-50 hover:cursor-pointer 
                      active:scale-95 transition-all text-green-700"
                      title="Active"
                    >
                      <BsCheck2 size={18} />
