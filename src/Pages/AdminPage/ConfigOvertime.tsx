...
// import { ViewOvertime } from "../../Components/ConfigOvertimeModal/ViewConfigOvertime";

// Icons
import { RiHistoryLine } from "react-icons/ri";

type OVERTIMET = "ADD" | "EDIT" | "DELETE" | "VIEW" | "";
...
export const ConfigOvertime = ({
  ...
  return (
    <div className="flex flex-col flex-grow bg-white overflow-hidden">
        ...
        <div className="min-w-[800px]">
          ...
          <div className="px-0.5 pt-0.5">
            <div className="grid grid-cols-[80px_1fr_1fr_160px] bg-blue-500 text-white rounded-lg items-center font-bold text-xs tracking-wider sticky top-0 z-10 gap-3 px-5 py-3 shadow-sm">
              ...
              <span className="text-left">Overtime Type</span>
            ...
            {paginatedData.length === 0 ? (
              ...
              <div className="flex flex-col gap-2">
                {paginatedData.map((item, index) => (
                  <div
                    key={item.id}
                    className="grid grid-cols-[80px_1fr_1fr_160px] items-center px-5 py-3 gap-3 text-sm bg-white
     ...
     /> */
        <div className="modal">
          <h3>Viewing: {selectedOvertime.overtimeType}</h3>
