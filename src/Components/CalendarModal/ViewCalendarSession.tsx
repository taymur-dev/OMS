      ...
      <div className="w-full max-w-4xl overflow-y-auto bg-white mx-auto rounded-xl shadow-xl">
        ...
        <div className="bg-white rounded-xl border-t-5 border-blue-400">
          <div className="text-white">
            <Title setModal={setModal}>VIEW ASSIGNED PROJECT</Title>
          </div>
        </div>
          ...
          <div className="border border-gray-200 rounded-lg overflow-hidden">
            <div className="max-h-[300px] overflow-y-auto">
              <table className="w-full text-left border-collapse">
                <thead className="sticky top-0 bg-blue-400 text-white text-[11px] uppercase tracking-wider">
                  <tr>
