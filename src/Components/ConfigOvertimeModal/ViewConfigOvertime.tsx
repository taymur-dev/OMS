...
import { FaClock, FaMoneyBillWave, FaHashtag, FaInfoCircle } from "react-icons/fa";
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="bg-blue-50 border border-blue-100 rounded-lg p-3">
             <p className="text-[11px] text-blue-700 leading-relaxed">
               <strong>Note:</strong> This configuration is applied to employee payroll calculations. 
               The rate is fixed based on the selected overtime hour type.
             </p>
          </div>
        </div>

        {/* Footer Section */}
        <div className="bg-gray-50 p-4 flex justify-end rounded-b-xl border-t border-gray-100">
          <button
            onClick={setModal}
